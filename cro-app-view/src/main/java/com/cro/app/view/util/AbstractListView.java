...
public abstract class AbstractListView<T extends AbstractBasicEntity> extends HorizontalLayout
...
//    viewLogic.init();
	...
	private HasComponents createTopBar() {
...
//      new Button("Nov" + getArtigoEntidade() + " " + getNomeEntidade());
	...
	public void saveObject(T object) {
		...
		if (newObject) {
			AbstractDataProvider<T> newDataProvider = (AbstractDataProvider<T>) grid.getDataProvider();
