package com.cro.app.model.util.webService;
...
public final class WebServiceCep {
   ...
   * @author Tomaz Lavieri
   */
  private static final class IterableElement
  ...
  /* Métodos e variaveis estaticas, respons�veis pela busca do CEP */
  /**
  ...
  /* PUBLIC métodos get e is, usado para acessar o objeto ap�s carregado. */
  /**
   ...
   * <BR><tt>-15</tt> : Não foi possível ler o documento XML
   * <BR><tt>-16</tt> : Erro na formarmato da url
